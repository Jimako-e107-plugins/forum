...
$FORUM_VIEWTOPIC_TEMPLATE['start'] 	= "
	...
	<div class='row row-fluid'>
		<div class='col-md-9 span9 pull-left float-left'><h3>{THREADNAME}</h3></div><div class='col-md-3 span3 pull-right float-right float-end right text-right'>{EMAILITEM} {PRINTITEM} {TRACK} {BUTTONSX}</div>
	</div>
